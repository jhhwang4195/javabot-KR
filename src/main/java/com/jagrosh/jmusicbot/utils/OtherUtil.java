...
public class OtherUtil
{
    ...
    public static Game parseGame(String game)
    {
        ...
        if(lower.startsWith("listening to"))
        	 return Game.playing(makeNonEmpty(game.substring(12).trim()));
        if(lower.startsWith("listening"))
        	 return Game.playing(makeNonEmpty(game.substring(9).trim()));
        if(lower.startsWith("watching"))
        	 return Game.playing(makeNonEmpty(game.substring(8).trim()));
